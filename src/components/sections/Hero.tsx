        ...
        <div className="max-w-[720px] mx-auto text-center">
          ...
          >
            <Text variant="h1" as="h1" className="mb-8 text-4xl sm:text-5xl lg:text-6xl bg-gradient-to-br from-gray-900 to-gray-600 bg-clip-text text-transparent">
              Stop missing credit card benefits worth hundreds to your annual fee
            </Text>
          </motion.div>
          <motion.div
            variants={fadeIn}
          ...
          >
            ...
            <motion.div
              ...
              className="mb-8 px-4 py-2 bg-green-50 border border-green-200 rounded-lg inline-block"
            >
              <Text variant="body" className="text-green-700 font-medium">
                ✨ Beta users are maximizing 90%+ of their card benefits • Launching publicly July 2025
              </Text>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="text-left">
                <Text variant="body" as="div" className="font-bold text-lg">Start Saving Now - Free</Text>
                <Text variant="tiny" as="div" className="opacity-90">Download on the App Store</Text>
              </div>
            </motion.a>
            ...
            >
              ...
              <Text variant="body" className="font-medium">Get notified for Android launch</Text>
            </motion.button>
            ...
            >
              <Text variant="tiny" className="text-gray-500">
                Limited beta access • Full launch July 2025
              </Text>
            </motion.div>
          </motion.div>
        </div>
