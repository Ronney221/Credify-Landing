      ...
      <div className="relative z-10 container min-h-[100dvh] px-4 mx-auto flex flex-col justify-center py-24 md:py-32">
        <div className="max-w-[720px] mx-auto text-center">
          ...
          <motion.div
            ...
            className="flex flex-col gap-4 justify-center max-w-[360px] mx-auto"
          >
            ...
            >
              <FeedbackForm className="w-full py-2 bg-white/50 hover:bg-white/80 text-gray-900 border border-gray-200 shadow-sm" />
            </motion.div>
