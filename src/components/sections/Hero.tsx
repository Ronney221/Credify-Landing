        ...
        <div className="max-w-[720px] mx-auto text-center">
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="flex-1 flex items-center justify-center px-4 py-3 bg-black text-white rounded-xl hover:bg-black/90 transition-colors shadow-lg hover:shadow-xl text-center"
            >
            ...
            <motion.div
              whileHover={{ scale: 1.03, y: -2 }}
              whileTap={{ scale: 0.98 }}
              className="flex-1 flex items-center justify-center px-4 py-3 bg-gray-200 text-gray-500 rounded-xl cursor-not-allowed shadow-lg hover:shadow-xl text-center"
            >
